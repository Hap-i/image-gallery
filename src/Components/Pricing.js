  ...
  return (
    <div id="pricing">
      ...
      <div className="space-y-14 mb-10 lg:flex lg:justify-center lg:space-y-0 lg:space-x-28 lg:mx-36">
        <div className="bg-color-2 text-center w-2/3 mx-auto shadow-xl shadow-black/40">
          ...
          <div className="mt-7 pb-7">
            <button className="bg-color-4 p-2">Enquire Now</button>
          </div>
        </div>
        <div className="bg-color-2 text-center w-2/3 mx-auto shadow-xl shadow-black/40 relative">
